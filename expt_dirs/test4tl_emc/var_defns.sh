...
#-----------------------------------------------------------------------
#
EXPT_BASEDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs"
EXPT_SUBDIR="test4tl_emc"

NET="fv3cam"
envir="FV3SAR_exp1"
RUN="experiment_name_XX"
...
#-----------------------------------------------------------------------
#
DATE_FIRST_CYCL="20200214"
DATE_LAST_CYCL="20200214"
CYCL_HRS=( \
"00" \
"12" \
)
export FCST_LEN_HRS=${FCST_LEN_HRS:-"24"}
#
#-----------------------------------------------------------------------
#
...
export LBC_UPDATE_INTVL_HRS=${LBC_UPDATE_INTVL_HRS:-"6"}
...
WRTCMP_write_tasks_per_group="54"
...
GRID_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_sar/conus"

RUN_TASK_MAKE_OROG="FALSE"
OROG_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_sar/conus"

RUN_TASK_MAKE_SFC_CLIMO="FALSE"
SFC_CLIMO_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_sar/conus"
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
WFLOW_LAUNCH_SCRIPT_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/launch_FV3SAR_wflow.sh"
WFLOW_LAUNCH_LOG_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc/log.launch_FV3SAR_wflow"
CRONTAB_LINE="*/03 * * * * cd /scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc && ./launch_FV3SAR_wflow.sh >> ./log.launch_FV3SAR_wflow 2>&1"
#
#-----------------------------------------------------------------------
#
# Directories.
...
#-----------------------------------------------------------------------
#
HOMErrfs="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow"
USHDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush"
SCRIPTSDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/scripts"
JOBSDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/jobs"
SORCDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/sorc"
PARMDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/parm"
MODULES_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/modulefiles"
EXECDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/exec"
FIXrrfs="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix"
FIXam="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_am"
FIXsar="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_sar/conus"
FIXgsm="/scratch1/NCEPDEV/global/glopara/fix/fix_am"
FIXupp="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_upp"
FIXgsd="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_gsd"
COMROOT="/scratch2/NCEPDEV/stmp3//com"
TEMPLATE_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates"
UFS_WTHR_MDL_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/sorc/ufs-weather-model"
UFS_UTILS_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/sorc/UFS_UTILS_develop"
CHGRES_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/sorc/UFS_UTILS_develop"
SFC_CLIMO_INPUT_DIR="/scratch1/NCEPDEV/da/George.Gayno/ufs_utils.git/climo_fields_netcdf"

EXPTDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc"
LOGDIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc/log"
GRID_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_sar/conus"
OROG_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_sar/conus"
SFC_CLIMO_DIR="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/fix/fix_sar/conus"
#
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc/var_defns.sh"

DATA_TABLE_TMPL_FN="data_table"
DIAG_TABLE_TMPL_FN="diag_table"
FIELD_TABLE_TMPL_FN="field_table"
FV3_NML_TMPL_FN="input.nml"
MODEL_CONFIG_TMPL_FN="model_configure"
NEMS_CONFIG_TMPL_FN="nems.configure"

DATA_TABLE_TMPL_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates/data_table"
DIAG_TABLE_TMPL_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates/diag_table"
FIELD_TABLE_TMPL_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates/field_table"
FV3_NML_TMPL_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates/input.nml"
MODEL_CONFIG_TMPL_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates/model_configure"
NEMS_CONFIG_TMPL_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates/nems.configure"

CCPP_PHYS_SUITE_FN=""
CCPP_PHYS_SUITE_IN_CCPP_FP=""
CCPP_PHYS_SUITE_FP=""

DATA_TABLE_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc/data_table"
FIELD_TABLE_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc/field_table"
FV3_NML_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc/input.nml"
NEMS_CONFIG_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/expt_dirs/test4tl_emc/nems.configure"

WRTCMP_PARAMS_TMPL_FP="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/ush/templates/wrtcmp_regional_latlon"
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
ISTART_OF_RGNL_DOM_WITH_WIDE_HALO_ON_T6SG="-3"
IEND_OF_RGNL_DOM_WITH_WIDE_HALO_ON_T6SG="1540"
JSTART_OF_RGNL_DOM_WITH_WIDE_HALO_ON_T6SG="-3"
JEND_OF_RGNL_DOM_WITH_WIDE_HALO_ON_T6SG="1540"
...
#
set -xu #cltthink
#clt LBC_UPDATE_FCST_HRS=(6 12 18 24)  # LBC_UPDATE_FCST_HRS is an array, even if it has only one element.
unset default_array
default_array=(0 3 6)
echo "thinkdeb 251 before " ${LBC_UPDATE_FCST_HRS[@]:-" Not intialized"}
LBC_UPDATE_FCST_HRS=(${LBC_UPDATE_FCST_HRS[@]:-"${default_array[@]}" }) 
# LBC_UPDATE_FCST_HRS is an array, even if it has only one element.
echo "thinkdeb251 LBC?? is "$LBC_UPDATE_FCST_HRS
  num_fhrs=${#LBC_UPDATE_FCST_HRS[@]}

echo "thinkdeb250 1 num_fhrs = " $num_fhrs
#
#-----------------------------------------------------------------------
#
...
export UTIL="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/regional_workflow/util/ush/"
HOMErrfs="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow"
export PARMfv3=$HOMErrfs/parm
export fixgsi="/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-regional-workflow/tl-fork_unified-workflow/regional_workflow/dev_GSI_fix"
...
#export WGRIB2=${EXECDIR}/wgrib2new
   if [ ${EXTRN_MDL_NAME_ICS}  = FV3GFS ] ; then	# SAR-DA
       ...
       cdate_FV3SAR=`$NDATE -${offset} $CDATE `
       LBC_UPDATE_FCST_HRS=(0 3 6 )
    #clt the above is following EMC workflow ' s convention 
    #clt the following is to change to the unified one's
    #the current treatment is specific for fv3gfs, a temperory work-around
           num_fhrs=${#LBC_UPDATE_FCST_HRS[@]}
        for (( i=0; i<=$((num_fhrs-1)); i++ )); do
           LBC_UPDATE_FCST_HRS[$i]=$(( ${LBC_UPDATE_FCST_HRS[$i]} - 0  ))  #cltthiknk temporary work-around 6 is correponsding to 6 hour DA window in FV3GFS
        done

#-----------------------------------------------------------------------
       elif [ $tmmark = tm00 ] ; then	# SAR-DA
       offset=`echo $tmmark | cut -c 3-4`
       cdate_FV3SAR=$CDATE 
    ...
    #the current treatment is specific for fv3gfs, a temperory work-around
       ...
       offset=06
       cdate_FV3SAR=`$NDATE -${offset} $CDATE `
       offset2=`echo $tmmark | cut -c 3-4`
       echo "thinkdeb here"
       export  LBC_UPDATE_FCST_HRS=(0 1 )
    ...
    #the current treatment is specific for fv3gfs, a temperory work-around
           num_fhrs=${#LBC_UPDATE_FCST_HRS[@]}
        for (( i=0; i<=$((num_fhrs-1)); i++ )); do
          LBC_UPDATE_FCST_HRS[$i]=$(( ${LBC_UPDATE_FCST_HRS[$i]} + offset  - offset2  ))  #cltthiknk temporary work-around 6 is correponsding to 6 hour DA window in FV3GFS
        done
       fi 
       offset=0  
  fi 
