...
# they are for the ICs namelist)?
  { cat > fort.41 <<EOF
&config
 mosaic_file_target_grid="/scratch2/NCEPDEV/fv3-cam/Ratko.Vasic/wrk/regional_workflow/fix/fix_sar/conus/C768_mosaic.nc"
 fix_dir_target_grid="/scratch2/NCEPDEV/fv3-cam/Ratko.Vasic/wrk/regional_workflow/fix/fix_sar/conus"
 orog_dir_target_grid="/scratch2/NCEPDEV/fv3-cam/Ratko.Vasic/wrk/regional_workflow/fix/fix_sar/conus"
 orog_files_target_grid="C768_oro_data.tile7.halo4.nc"
 vcoord_file_target_grid="/scratch2/NCEPDEV/fv3-cam/Ratko.Vasic/wrk/regional_workflow/fix/fix_am/global_hyblev.l65.txt"
...
#
  echo "thinkdeb250 "  ${LBC_UPDATE_FCST_HRS[$i]}
  lbc_hr=$(( ${LBC_UPDATE_FCST_HRS[$i]} - ${LBC_UPDATE_FCST_HRS[0]}  ))
#cltorg   fcst_hhh_FV3SAR=$( printf "%03d" "${LBC_UPDATE_FCST_HRS[$i]}" )
  fcst_hhh_FV3SAR=$( printf "%03d" "${lbc_hr}" )
